...
def train(args):
    ...
    while True:
        ...
        # optimizer.descent_step(lr, max_lr, iter_num > 10000)
...
if __name__=="__main__":
    ...
    parser.add_argument("--wandb_project", default= 'llama_pile_std', type=str, help="Wandb project.")
    ...
    parser.add_argument("--save_interval", default=15000, type=int, help="..")
...
# # To run this .py (ddp)
# CUDA_VISIBLE_DEVICES=0,1 python3 -m torch.distributed.run --standalone --nproc_per_node=2 train_adamire_pile_Llama_fine.py --batch_size=15 --grad_micro_steps=10 --total_bs=300 --rank=0.1 --prog=0.0 --max_lr=3e-4 --wandb_log --wandb_run_name=base3 --skip_init
# CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m torch.distributed.run --standalone --nproc_per_node=4 train_adamire_pile_Llama_fine.py --batch_size=15 --grad_micro_steps=5 --total_bs=300 --rank=0.1 --prog=0.0 --max_lr=3e-4 --wandb_log --wandb_run_name=base3