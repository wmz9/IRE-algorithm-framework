...
if __name__=="__main__":
    ...
    parser.add_argument("--wandb_project", default= 'gpt_web', type=str, help="Wandb project.")
    ...
    parser.add_argument("--eval_interval", default=500, type=int, help="..")
...
# # or
# CUDA_VISIBLE_DEVICES=4,5,6,7 python3 -m torch.distributed.run --standalone --nproc_per_node=4 train_adamire_web_gpt.py --batch_size=8 --grad_micro_steps=15 --total_bs=480 --rank=0.1 --prog=4.0 --prog_decay --max_lr=3e-4 --wandb_log --wandb_run_name=moving_4_01