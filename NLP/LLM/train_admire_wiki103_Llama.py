...
# # To run this .py (ddp)
# torchrun --standalone --nproc_per_node=2 train_admire_wiki103_Llama.py --batch_size=40 --grad_micro_steps=3 --total_bs=240 --max_iters=50000 --max_lr=6e-4 --rank=0.4 --prog=3